...
const PrayerRecordFieldComponent = ({
  handleChange,
  index,
  recordData,
}: recordFieldProps) => {
  return (
    <>
      ...
      <div className="flex flex-col items-center w-full mb-5">
        <label htmlFor={`program${index + 1}`} className="w-1/2 text-xs">
          Program:
        </label>
        <input
          type="text"
...
export default PrayerRecordFieldComponent;
